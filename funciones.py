...
def purchase_construct(sku_df, pat, status, warehouse):
    ...
    new_df = sku_df[[
        ...
        'PRODUCTSIZEID', 'PRODUCTSTYLEID', 'PURCHASEPRICE', 'PURCHASEUNITSYMBOL', 'RECEIVINGSITEID', 'RECEIVINGWAREHOUSEID',
        'REQUESTERPERSONNELNUMBER', 'SALESTAXGROUPCODE', 'SALESTAXITEMGROUPCODE']]
