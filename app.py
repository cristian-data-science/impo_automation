...
def show_insights(col1, col2):
    with col2:
        ...
        grid_options_builder.configure_default_column(groupable=True, filter=True, sortable=True, resizable=True,fit_columns_on_grid_load=False, enable_enterprise_modules=True)
        grid_options = grid_options_builder.build()   
